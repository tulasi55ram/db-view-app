/**
 * Shared API types for both Electron and VS Code platforms
 */
...
// Platform detection
export type Platform = "electron" | "vscode" | "web";
...
/**
 * Core Database API interface - implemented by both Electron and VS Code
 */
export interface DatabaseAPI {
  ...
  // File dialogs (optional - may not be available in webview)
