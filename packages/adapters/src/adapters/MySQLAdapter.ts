...
export class MySQLAdapter extends EventEmitter implements DatabaseAdapter {
  ...
  async cancelQuery(queryId: string): Promise<void> {
    ...
    try {
      ...
      console.log(`[MySQLAdapter] Successfully cancelled query ${queryId} (Connection ID: ${connectionId})`);
    } catch (error) {
      console.error(`[MySQLAdapter] Failed to cancel query ${queryId}:`, error);
